...
public class TabelaMenina implements Tabela {
	
	@Override
	public String gerar() {
		return "<br>"
				+"<h2>Tabela Menina (Entre 2 e 20 anos):</h2>"
				...
				+ "<br><br>"
				+ "<img src=\"https://www.mdsaude.com/wp-content/uploads/IMC-crianca-meninas.png\">";
	}
